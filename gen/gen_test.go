...
func TestGen_BuildDescriptionWithQuotes(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/5999ft/swag/v2/testdata/quotes")
...
func TestGen_BuildDocCustomDelims(t *testing.T) {
	...
	cmd := exec.Command("go", "build", "-buildmode=plugin", "github.com/5999ft/swag/v2/testdata/delims")
