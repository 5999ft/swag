...
func TestParseTypeOverrides(t *testing.T) {
	...
	p := New(SetOverrides(map[string]string{
		"github.com/5999ft/swag/v2/testdata/global_override/types.Application":  "string",
		"github.com/5999ft/swag/v2/testdata/global_override/types.Application2": "github.com/5999ft/swag/v2/testdata/global_override/othertypes.Application",
		"github.com/5999ft/swag/v2/testdata/global_override/types.ShouldSkip":   "",
	}))
	err := p.ParseAPI(searchDir, mainAPIFile, defaultParseDepth)
	assert.NoError(t, err)
